...
namespace FactoryDesignPattern
{
    public class BadCode
    {
        ...
        {
            IVehicle honda = VehicleFactory.CreateVehicle(VehicleBrand.Honda);
            honda.Start();
            honda.Stop();
            IVehicle bmw = VehicleFactory.CreateVehicle(VehicleBrand.BMW);
            bmw.Start();
            bmw.Stop();
            IVehicle toyota = VehicleFactory.CreateVehicle(VehicleBrand.Toyota);
            toyota.Start();
            toyota.Stop();
        }
    }
